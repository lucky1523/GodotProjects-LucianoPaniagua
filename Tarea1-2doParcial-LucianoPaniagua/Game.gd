...
var unpressed = preload("res://assets/messi.png")
var player_x = preload("res://assets/cruz.png")
var player_o = preload("res://assets/circulo.png")
...
func check_gameover() -> void:
	if line_win() || column_win() || diagonal_win():
		is_gameover = true
